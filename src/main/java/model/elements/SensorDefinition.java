...
//	B1_S01("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S01", "B1_S01", "Reedkontakt Registerlager", 0, 0, Direction.North),
	B1_S02("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S02", "B1_S02", "Lichtschranke Registerlager", 1010, 310, Direction.North),
	B1_S03("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S03", "B1_S02", "Initiator Förderband 1.1", 780, 230, Direction.South),
//	B1_S04("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S04", "B1_S04", "Reedkontakt Farberkennung links", 0, 0, Direction.North),
//	B1_S05("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S05", "B1_S05", "Reedkontakt Farberkennung rechts", 0, 0, Direction.North),
	B1_S06("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S06", "B1_S06", "Taster Registerlager", 1110, 230, Direction.North),
	
	B1_S07("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S07", "B1_S07", "Initiator Förderband 1.2", 610, 310, Direction.North),
	B1_S08("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S08", "B1_S08", "Initiator Förderband 1.3 vorn", 500, 310, Direction.North),
...
//	B1_S15("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S15", "B1_S15", "Quetschutz linker Flügel", 0, 0, Direction.North),
	B1_S16("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S16", "B1_S16", "Lichtschranke Einfahrt", 470, 230, Direction.South),
	...
	B1_S09("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S09", "B1_S09", "Initiator Förderband 1.3 hinten", 380, 310, Direction.North),
...
//	B1_S20("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S20", "B1_S20", "Initiator Drehtisch", 0, 0, Direction.North),
	...
	B1_S23("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S23", "B1_S23", "Initiator Förderband ganz links", 100, 230, Direction.South),
	B1_S24("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S24", "B1_S24", "Initiator Förderband oben", 310, 100, Direction.East);
