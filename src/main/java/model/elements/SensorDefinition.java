...
//	B1_S01("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S01", "B1_S01", "Reedkontakt Registerlager", 0, 0, Direction.North),
	...
	B1_S03("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S03", "B1_S03", "Initiator Förderband 1.1", 780, 230, Direction.South),
	B1_S04("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S04", "B1_S04", "Reedkontakt Farberkennung links", 900, 310 , Direction.North),
	B1_S05("ns=4;s=|var|CODESYS Control Win V3 x64.Application.Globale_Variablen.B1_S05", "B1_S05", "Reedkontakt Farberkennung rechts", 900, 230, Direction.South),
